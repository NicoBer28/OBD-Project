...
#define CHARACTERISTIC_UUID_RX                                                                                         \
    "6E400002-B5A3-F393-E0A9-E50E24DCCA9E" // caracteristica RX (recepción de la ESP, la app escribe)
#define CHARACTERISTIC_UUID_TX                                                                                         \
    "6E400003-B5A3-F393-E0A9-E50E24DCCA9E" // caracteristica TX (transmisión de la ESP, la app lee/notifica)
...
extern "C" void app_main(void)
{
    ...
    NimBLECharacteristic* pRxCharacteristic =
        pService->createCharacteristic(CHARACTERISTIC_UUID_RX, NIMBLE_PROPERTY::WRITE | NIMBLE_PROPERTY::WRITE_NR);
    ...
    pTxCharacteristic =
        pService->createCharacteristic(CHARACTERISTIC_UUID_TX, NIMBLE_PROPERTY::NOTIFY | NIMBLE_PROPERTY::READ);
