...
enum _AddMode { none, group, email, guest }
...
class _TripPeopleSheetState extends State<TripPeopleSheet> {
  ...
  Future<void> _saveCost() async {
    ...
    if (text.isNotEmpty && parsed == null) {
      ApiMessages.show(context, const ApiException(statusCode: 400, detail: 'Ingresá solo números'));
      return;
    }
    setState(() => _busy = true);
    try {
  ...
  Future<void> _invite() async {
    ...
    if (!email.contains('@')) {
      ApiMessages.show(context, const ApiException(statusCode: 400, detail: 'Ingresá un correo válido'));
      return;
    }
    if (name.isEmpty) {
      ApiMessages.show(context, const ApiException(statusCode: 400, detail: 'Ingresá un nombre'));
      return;
    }
    setState(() => _busy = true);
    try {
            ...
            children: [
              ...
              if (participants != null) ...[
                ...
                if (isDriver) ...[
                  ...
                  _AddSection(
                    mode: _addMode,
                    onModeChanged: (m) => setState(() => _addMode = m == _addMode ? _AddMode.none : m),
                    busy: _busy,
        ...
        return Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: FilledButton(onPressed: busy ? null : onInvite, child: const Text('Sumar al viaje')),
            ),
          ],
        );
    }
...
class _ModeChip extends StatelessWidget {
  ...
  final ValueChanged<_AddMode> onTap;
