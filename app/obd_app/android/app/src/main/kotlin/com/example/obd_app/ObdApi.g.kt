...
private object ObdApiPigeonUtils {
...
data class TelemetryEvent (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): TelemetryEvent {
      val speed = pigeonVar_list[0] as Long?
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + ObdApiPigeonUtils.deepHash(this.speed)
    result = 31 * result + ObdApiPigeonUtils.deepHash(this.rpm)
...
class ObdFlutterApi(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  companion object {
    /** The codec used by ObdFlutterApi. */
    val codec: MessageCodec<Any?> by lazy {
      ObdApiPigeonCodec()
    }
  }
  suspend fun onTelemetryUpdated(eventArg: TelemetryEvent)
{
